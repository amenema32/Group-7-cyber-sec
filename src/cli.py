"""
LoFAD CLI - Log File Anomaly Detector

This is the command-line interface for LoFAD.
It helps you monitor log files in real-time and detect suspicious activity.

Examples:
    Run normally:
        lofad --config config.json

    Send a test alert:
        lofad --config config.json --test-alert
"""
import argparse
import sys
